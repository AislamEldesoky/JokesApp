...
import com.example.islameldesoky.jokesapp.JokeAsyncTask;
    ...
    public void tellJoke(View view) {
       new JokeAsyncTask(){
           ...
           protected void onPostExecute(String s){
               if (s!=null){
                   startActivity(JokerActivity.JokeIntent(FreeActivity.this,s));
               }else{
                   Toast.makeText(FreeActivity.this,"error",Toast.LENGTH_SHORT);
               }
           }
       }.execute();
